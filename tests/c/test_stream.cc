...
TEST(stream, byte_in_stream_c) {
  ...
  ASSERT_TRUE(read_iop_execute(&iop));
  ASSERT_EQ(2, read_iop_bytes_read(&iop));
  ASSERT_EQ(10, buf[0]);
  ASSERT_EQ(9, buf[1]);
  ASSERT_EQ(0, buf[2]);
  ASSERT_EQ(0, buf[3]);
  ...
  ASSERT_TRUE(read_iop_execute(&iop));
  ASSERT_EQ(3, read_iop_bytes_read(&iop));
  ASSERT_EQ(8, buf[0]);
  ASSERT_EQ(7, buf[1]);
  ASSERT_EQ(6, buf[2]);
  ASSERT_EQ(0, buf[3]);
  ...
  ASSERT_TRUE(read_iop_execute(&iop));
  ASSERT_EQ(4, read_iop_bytes_read(&iop));
  ASSERT_EQ(5, buf[0]);
  ASSERT_EQ(4, buf[1]);
  ASSERT_EQ(3, buf[2]);
  ASSERT_EQ(2, buf[3]);
  ...
  read_iop_recycle_same_state(&iop);
  ASSERT_TRUE(read_iop_execute(&iop));
  ASSERT_EQ(0, read_iop_bytes_read(&iop));
  ASSERT_EQ(1, buf[0]);
  ASSERT_EQ(0, buf[1]);
  ASSERT_EQ(3, buf[2]);
  ASSERT_EQ(2, buf[3]);
